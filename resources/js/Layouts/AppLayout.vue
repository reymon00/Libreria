            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('Usuarios')" :activate="route().current('Usuarios')">
                                    Usuarios
                                </NavLink>

                                <NavLink :href="route('Libros')" :activate="route().current('Libros')">
                                    Libros
                                </NavLink>
                                
                                <NavLink :href="route('Autores')" :activate="route().current('Autores')">
                                    Autores
                                </NavLink>
                                <NavLink :href="route('Editoriales')" :activate="route().current('Editoriales')">
                                    Editoriales
                                </NavLink>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('Libros')" :active="route().current('Libros')">
                            Libros
                        </ResponsiveNavLink>

                        <ResponsiveNavLink :href="route('Autores')" :active="route().current('Autores')">
                            Autores
                        </ResponsiveNavLink>

                        <ResponsiveNavLink :href="route('Editoriales')" :active="route().current('Editoriales')">
                            Editoriales
                        </ResponsiveNavLink>
